...
import { Visibility, VisibilityOff, Badge as BadgeIcon, Lock, ArrowBack } from '@mui/icons-material';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        // Store employee token and user in Redux + localStorage
    ...
    <Box sx={{
      ...
      <Paper sx={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            {loading ? <CircularProgress size={24} color="inherit" /> : '👤 Sign In as Employee'}
          </Button>
        </form>
